...
const ImageStyled = styled.img`
  ...
  &.inactive {
    animation: ${fadeOut} 0.7s ease 0s;
  }
`;
...
const ImageHeader = () => {
  ...
  const updateImage = useCallback((num: number) => {
  ...
  return (
    <ImageHeaderStyled>
      <ImageStyled src={img} ref={imageRef} alt="header" />
      <AuthorStyled>
        <a href={"https://pixabay.com/ja/users/" + author.id}>{author.name}</a>
        {" による "}
